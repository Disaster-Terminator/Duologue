...
type RuntimeEventSummary =
  Pick<RuntimeEvent, "id" | "timestamp" | "level" | "category" | "phaseStep" | "sourceRole" | "targetRole" | "round"> & {
...
function summarizeEvents(events: RuntimeEvent[] | null | undefined): RuntimeEventSummary[] {
  if (!events?.length) {
    return [];
  }
